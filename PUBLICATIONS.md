...
This file summarizes selected publications and research outputs reported in my academic profiles and CvLAC. For a complete list, please visit my [Google Scholar profile](https://scholar.google.com/citations?hl=es&user=9UgSP3oAAAAJ).

The entries are organized from the most recent to the oldest and include links to papers, DOIs, proceedings, thesis documents, and related materials when available.
